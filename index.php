...
<p>For a live sample see: <a href="http://rerickso.w3.uvm.edu/php-form/supporting/commit-13/form.php" target="_blank">http://rerickso.w3.uvm.edu/php-form/form.php</a></p>
